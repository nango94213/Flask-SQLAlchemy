...
b1 = Book(id=12, title='Hundred years of solitude', author_name='Gabriel', author_surname='Garcia Marquez',
...
b5 = Book(id=19, title='Guns, Germs and Steel', author_name='Jared', author_surname='Diamond', month='August',
          year='2019')
db.session.add(b1)
db.session.add(b2)
db.session.add(b3)
...
rev4 = Review(id=114, text='Albert Camus is an amazing writer who really understands the society.', stars=4,
              reviewer_id=r2.id, book_id=b2.id)
rev5 = Review(id=115,
              ...
              stars=4, reviewer_id=r2.id, book_id=b2.id)
rev6 = Review(id=116, text='Despite the fascinating subject matter I found this book a bit dry.', stars=3,
              reviewer_id=r4.id, book_id=b5.id)
rev7 = Review(id=117, text='I liked this book, and it taught me a bunch of things.', stars=5, reviewer_id=r3.id,
              book_id=b5.id)
...
ann2 = Annotation(id=332, text='I opened myself to the gentle indifference of the world.', reviewer_id=r1.id,
                  book_id=b2.id)
ann3 = Annotation(id=333, text='Everything is true, and nothing is true!', reviewer_id=r2.id, book_id=b2.id)
ann4 = Annotation(id=334, text='Good that you ask -- you should always ask, always have doubts.', reviewer_id=r3.id,
                  book_id=b4.id)
db.session.add(ann1)
db.session.add(ann2)
db.session.add(ann3)
